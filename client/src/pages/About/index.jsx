...
<h1 className="  text-md md:text-3xl mx-14  font-semibold text-white  ml-10 sm-text-md font-Merriweather   py-6 ">About Msit Alumni Association</h1>



 <p className="text-sm md:text-xl mx-14 mb-3 text-white mt-2 sm-text-sm ml-10">Our key objective is to nurture and strengthen the 
 Institute’s bond with its alumni community, business corporations and philanthropists.
. These include setting up world class research and academics in emerging areas of science and technology,
  building world class infrastructure, improving faculty value proposition,
  strengthening the entrepreneurship ecosystem, and contributing to the society.
     </p>

     <p className="text-sm md:text-xl italic   mx-14 justify-between text-white ml-10 mb-3  sm-text-sm font-Merriweather  mt-3">"Staying connected with the place that gave you a chance to learn and discover yourself is refreshing !"</p>
...
<div className="bg=[#F5F5F5] mx-auto md:flex   ">
 ...
 <div className="w-full ml-4 items-center content-center">
    ...
    8000+ accomplished graduates in a variety of professions. Founded in 2019, MSIT Alumni Association is an independent, registered organisation that includes more than 4000 alumni working in different countries 
    and works to strengthen relationships. The Alumni Affairs Advisory Committee is comprised  of faculty members and students.</p>

       <p className="  text-md  md:text-lg text-black  mt-2 mb-2 font-Merriweather ">
       The strength of our institution rests on its graduates, whose achievements and contributions are a testament
        to the quality of education and the values, they learnt here. MSIT graduates have achieved remarkable success 
       in a variety of fields, including technology, business, government and academia.
       </p>

       <p className="  text-md  md:text-lg text-black  mt-2 mb-2  font-Merriweather "> As you continue to make your mark in the world,
        we encourage you to stay connected with us and with your fellow alumni, 
       share your experiences, and continue to be a part of our institution's growth and development
       </p>

       <h4 className=" text-lg md:text-xl font-semibold text-black mt-2 mb-2 font-Merriweather">The Alumni Affairs Team provides various facilities and services such as:</h4>
        <ul> 
        <li className='  text-md  md:text-lg text-black  mt-2 mb-2  font-Merriweather '>•	Provide opportunities to stay connected and engaged with your alma mater.</li>
        <li className='  text-md  md:text-lg text-black  mt-2 mb-2  font-Merriweather '>•		Technical and academic collaboration can also be valuable, as alumni have expertise in a variety of areas that can benefit their alma mater.</li>
        <li className='  text-md  md:text-lg text-black  mt-2 mb-2  font-Merriweather '>•		Student interaction and mentoring can be especially valuable, as alumni can offer advice and support to current students.</li>
        <li className='  text-md  md:text-lg text-black  mt-2 mb-2  font-Merriweather '>•	Contributions to the Institute can help ensure the continued success and growth of the institution, through donations, volunteerism, or other forms of support.</li>
        </ul>
         
        <p className="  text-md  md:text-lg text-black  mt-2 mb-2 font-Merriweather ">We look forward to staying connected with you and hearing about your accomplishments and successes.</p>
      ...
      <section className=" font-Merriweather">
        <div className="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-12 lg:px-4">
            <div className="mx-auto mb-4 max-w-screen-sm lg:mb-10">
                ...
                <h2 className="mb-4 text-4xl font-semibold text-[#064663]  ">Faculty Team</h2>
